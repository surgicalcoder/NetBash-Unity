...
function NetBash($, window, opt) {
    ...
    this.initUI = function () {
        ...
        var controls = $('<div id="console-result"><div class="console-message">' + options.welcomeMessage + '</div></div><div id="console-input"><span>></span><input type="text" placeholder="NetBash-DotNetPro-Unity ' + options.version + ' " /></div>').appendTo(container);
